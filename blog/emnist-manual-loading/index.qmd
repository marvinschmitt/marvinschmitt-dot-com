...
description: "A quick guide to download the EMNIST data set manually when the PyTorch loader fails."
date: 04-15-2024
categories: 
  - programming
  - python
...
**TL;DR:** Manual EMNIST data download requires directory name updates to make `PyTorch` happy.
:::
