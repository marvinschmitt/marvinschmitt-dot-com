...
description: "Here's a quick rundown of this ggplot extension for scatter and density plots in a (2-)simplex."
date: 02-04-2023
categories: 
  - statistics
  - R
...
But there is one problem. The fancy triangular density plots use an internal and highly experimental ggplot extension: [`{ggsimplex} (GitHub source)`](https://github.com/marvinschmitt/ggsimplex)
